/* Motor de pixelizacao exportado do LinhaPIXEL.html.
   PixelAnim(canvas, svgSource, cfg) desenha um SVG (animado ou nao) num
   <canvas> com mosaico + posterize via WebGL.
   Nao editar a mao: se gerares uma animacao nova no gerador, volta a exportar. */
(function () {
  'use strict';
...
requestAnimationFrame(loop);
  ...
  var SVG_CIRC  = "<svg xmlns:xlink=\"http://www.w3.org/1999/xlink\" xmlns=\"http://www.w3.org/2000/svg\" fill=\"none\" height=\"900\" width=\"900\" viewBox=\"660 240 600 600\"><g transform=\"matrix(1,0,0,1,1003,547)\" id=\"i0\" style=\"transform:matrix(1, 0, 0, 1, 1003, 547);transform-origin:0px 0px;transform-box:view-box;opacity:1;fill-opacity:1;fill-rule:nonzero;stroke-opacity:1;stroke-width:1px;stroke-linecap:butt;stroke-linejoin:miter;stroke-dashoffset:0px;stroke-miterlimit:4;cx:0px;cy:0px;r:0px;x:0px;y:0px;font-size:13px;font-family:ui-monospace, SFMono-Regular, Menlo, monospace;font-weight:400;text-anchor:start;visibility:visible;display:inline;\"><g id=\"i1\" transform=\"matrix(1,0,0,1,-43,-7)\" style=\"transform:matrix(1, 0, 0, 1, -43, -7);transform-origin:0px 0px;transform-box:view-box;opacity:1;fill-opacity:1;fill-rule:nonzero;stroke-opacity:1;stroke-width:1px;stroke-linecap:butt;stroke-linejoin:miter;stroke-dashoffset:0px;stroke-miterlimit:4;cx:0px;cy:0px;r:0px;x:0px;y:0px;font-size:13px;font-family:ui-monospace, SFMono-Regular, Menlo, monospace;font-weight:400;text-anchor:start;visibility:visible;display:inline;\"><ellipse ry=\"283\" rx=\"283\" cy=\"0\" cx=\"0\" stroke-width=\"26\" stroke=\"#ffffff\" style=\"transform-origin:0px 0px;transform-box:view-box;opacity:1;fill-opacity:1;fill-rule:nonzero;stroke:rgb(255, 255, 255);stroke-opacity:1;stroke-linecap:butt;stroke-linejoin:miter;stroke-dashoffset:0px;stroke-miterlimit:4;cx:0px;cy:0px;r:0px;rx:283px;ry:283px;x:0px;y:0px;font-size:13px;font-family:ui-monospace, SFMono-Regular, Menlo, monospace;font-weight:400;text-anchor:start;visibility:visible;display:inline;\"/></g></g></svg>";
  var CFG_CIRC  = {"hb": 50, "vb": 50, "lv": 6, "speed": 1, "mosaic": true, "posterize": true, "sharp": true, "alphaCut": true, "alphaThresh": 0.32, "alphaSteps": 1, "ditherType": 0, "ditherSize": 1, "ditherAmt": 1, "ditherAlpha": false, "ditherOn": false, "dLv": 4, "forceOn": true, "forceThresh": 0.21, "forceRGB": [1, 0.89411765, 0.48235294], "bgRGB": [0, 0, 0], "bgOpaque": false, "bg": null, "tint": null, "base": "#ffffff", "w": 900, "h": 900};
